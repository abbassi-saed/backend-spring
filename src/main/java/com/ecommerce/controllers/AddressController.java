...
import com.ecommerce.requests.user.AddressRequest;
import com.ecommerce.responses.user.AddressResponse;
import com.ecommerce.services.user.AddressService;
...
public class AddressController {
	...
	public ResponseEntity<List<AddressResponse>> getAddresses(Principal principal) {
		...
		// get name contien always the field by what the user get authentified
